...
![https://run.claw.cloud/pricing](/public/images/post/ClawCloud/run-claw-cloud-pricing-page.png)
### 2. 之后，点击右上角的"Get started"按钮，你会被跳转去：
![https://eu-central-1.run.claw.cloud/signin](/public/images/post/ClawCloud/run-claw-cloud-signin-page.png)
### 3. 使用GitHub注册/登录，之后授权、就好了（没那么难把？）
:::

## 你注册后注册后，会到：
![https://eu-central-1.run.claw.cloud/](/public/images/post/ClawCloud/run-claw-cloud-main-page.png)
...
3. 到了那个页面后推荐这样设置：
![AstrBot Confuguration](1224HuangJin/blog/public/images/post/ClawCloud/astrbot-confuguration.png)
::: tip 设置
