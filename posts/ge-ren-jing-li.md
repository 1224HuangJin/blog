...
>
> 呜呜呜，现在只有33%的电池寿命了（2026/05/18）
:::

::: timeline 2024年 - 2025年（初二+初三）
## 2024年 - 2025年（由于我不确定具体那年所以合一起）
### 域名
> 在这年，我记得我**拥有了**我的**第一个免费的域名**（二级域名），我彻底**对域名沉迷**了，所以、寻找了很多免费域名、可有**那么多域名**我可以干什么呢？

>> 毕竟，我既**不会编程**、也不懂什么。当时、我连DNS都不知道是什么
>
...
> （DigitapPlat 真的是我在24年找到的吗..？我已经忘记了、哈哈）
> > 它的注册教程： [blog.1224hj.top](/posts/digitalplat-freedomain)
>
> ### 学习/认识到的东西：
> 1. 在这一年、我**第一个学习到了**：这世界上还有 **开源代码** 这一个东西。
> 2. **了解**了有某些**内容**有**版权**，**LICENSE**...
...
> - 使用了ChatGPT和DeepSeek等AI成功制作了一个**链接缩短器**，虽然是全AI弄得、但怎么说也算是我完全没接触任何东西的时候的第一个网站？，然后也很久没维护了（使用的是InfinityFree托管PHP代码）
...
另外，非常感谢Kananosa
Ta 可以算是我接触到更高层"编程代码"类内容的重要人物，如果没有ta、我也接触不到SiiWay，我也不能了解更多东西...
...
> 这2个项目其实都是**从Mifeng那里抄来的**、因为**她好像也是从imsyy抄过来**，但**她推荐我用她的**。
>
